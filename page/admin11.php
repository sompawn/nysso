...
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Kch <span class="color-p"> Uploads</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i> แก้ไขข้อมูล</a></li>
            <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> เปลี่ยนรหัส</a></li>
            <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> เพิ่มผู้ใช้งาน</a></li>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">สวัสดีคุณ</p>
          <p class="app-sidebar__user-designation"><?php print_r($_SESSION["User"]);?></p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Flie management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="form-upload.php"><i class="icon fa fa-circle-o"></i> Upload Flie</a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>ระบบจัดการไฟล์สำหรับหน้าเว็บ</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-6">
          ...
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              <h4>จัดซื้อ-จัดจ้างวัสดุวิทยาศาสตร์ ฯ</h4>
              <p><b>500</b></p>
            </div>
          </div>
        </div>
